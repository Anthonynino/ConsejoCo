...
const tiposPermiso = [
  ...
  "Campaña de zoonosis",
  "Permiso para actividades agrícolas",
  "Permiso para actividades ganaderas",
]
...
const EnviromentPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    console.log(form)
    try {
      await generarConstancia({ ...form, titulo: "AMBIENTAL" })
      toast.success("Constancia de ambiente generada correctamente")
    }  catch (error) {
  ...
  if (error.response) {
    ...
    console.error("Error al generar constancia de ambiente:", error)
  }
  ...
  return (
    <div className="w-full space-y-6 mx-auto p-6">
      ...
      <HeaderModules
        ...
        description="Genera e imprime constancias para trámites ante Ambiente Municipal"
